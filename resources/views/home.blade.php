			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active">
						<a class="nav-link "  href="index.html"><span class="btn btn-primary rounded-circle animate__animated animate__swing">ទំព័រដើម</span> </a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="scholarship.html"> <span class="btn  btn-white rounded-circle animate__animated animate__swing">  ដំណឹងអាហារូករណ៍</span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="scholarship.html"><span class="btn  btn-white rounded-circle animate__animated animate__swing">ប្រភពចំណេះដឹង</span> </a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#"><span class="btn  btn-white rounded-circle animate__animated animate__swing">ព័ត៌មានអំពីយើង</span> </a>
					</li>
					<li class="nav-item">
                        <a class="nav-link"href="#"><span class="btn  btn-white rounded-circle animate__animated animate__swing">ទាក់ទងជាមួយយើង</span> </a>
                    </li>
                    <li class="nav-item">
						<a class="nav-link" href="#"><span class="btn  btn-white rounded-circle animate__animated animate__swing  ">ចូលគណនី</span> </a>
					</li>
					<li class="nav-item">
						<a class="nav-link"href="#"><span class="btn  btn-white rounded-circle animate__animated animate__swing  ">ចុះឈ្មោះ</span> </a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="carousel slide" data-ride="carousel" id="carouselExampleIndicators">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
                <img alt="First slide" class="d-block w-100" src="https://wallpaperaccess.com/full/254367.png">
                <img alt="Second slide" class="d-block w-100" src="https://www.edgehill.ac.uk/courses/files/BA-Hons-Early-Childhood-Studies-and-Sociology.jpg">
				<div class="carousel-caption d-none d-md-block">
					<h2 class="animated bounceInRight" style="animation-delay: 1s">We Are <span>Creative</span></h2>
                            ...
                            <p class="animated bounceInRight" style="animation-delay: 3s"><a href="#"><span class="btn btn-white">ចូលគណនី</span></a>&nbsp<a href="#"><span class="btn btn-white">ចុះឈ្មោះ</span></a></p>
				</div>
			</div>
			<div class="carousel-item">
				...
				<div class="carousel-caption d-none d-md-block">
					<h2 class="animated slideInDown" style="animation-delay: 1s">We Are <span>Franco</span></h2>
                        ...
                        <p class="animated zoomIn" style="animation-delay: 3s"><a href="#"><span class="btn btn-white">ទាក់ទងជាមួយយើង</span></a></p>
				</div>
			</div>
			<div class="carousel-item">
				<img alt="Third slide" class="d-block w-100" src="https://i.pinimg.com/originals/12/c7/c3/12c7c30ba7e9a85b2ca11d0963545b29.jpg">
				<div class="carousel-caption d-none d-md-block">
					<h2 class="animated zoomIn" style="animation-delay: 1s">We Are <span>Diligent</span></h2>
                        ...
                        <p class="animated zoomIn" style="animation-delay: 3s"><a href="#"><span class="btn btn-white">ព័ត៌មានអំពីយើង</span></a></p>
				</div>
			</div>
    ...
    <section><br>
        ...
        <div class="row">
            ...
            <div  data-aos="fade-left" class="btn btn-warning rounded-circle col" >
                <h1 class="header " class="btn btn-white rounded-circle animate__animated animate__bounce" data-aos="animate text on scroll">ដំណឹងអាហារូករណ៍ 
        ...
        <main class="container" style="overflow: hidden; background-color: #625d5d1c;" >
                          ...
                          សង្ខេប៖ ការជ្រើសរើសសិស្សនិស្សិតអាហារូបករណ៍រដ្ឋាភិបាលជប៉ុន (MEXT) ថ្នាក់ក្រោយឧត្តមសិក្សា (អនុបណ្ឌិតនិងបណ្ឌិត) ថ្នាក់ឧត្តមសិក្សា (បរិញ្ញាបត្រ) ថ្នាក់មធ្យមសិក្សាបច្ចេកទេស និងថ្នាក់បណ្តុះបណ្ដាលវិជ្ជាជីវៈ (បួនកម្រិត) លើជំនាញផ្សេងៗទៅសិក្សានៅប្រទេសជប៉ុន ចូលរៀនខែមេសា និងតុលា​ ឆ្នាំ ២០២១ ចាប់បើកទទួលពាក្យហើយ។​ អត្ថប្រយោជន៍៖ ខាង MEXT រ៉ាប់រងទាំងអស់មានថ្លៃសាលា
                              ...
                              <div class="bg-white p-2">
                                  <div class="d-flex flex-row fs-12">
                                      <div class="like p-2 cursor"><i class="fab fa-gratipay fa-lg" id="like" ></i><span class="ml-1">Like</span></div>
                                      <div class="like p-2 cursor action-collapse" data-toggle="collapse" aria-expanded="true" aria-controls="collapse-1" href="#collapse-1"><i class="fas fa-comment fa-lg" id="comment"></i><span class="ml-1">Comment</span></div>
                                      <div class="like p-2 cursor action-collapse" data-toggle="collapse" aria-expanded="true" aria-controls="collapse-2" href="#collapse-2"><i class="fas fa-share-alt fa-lg" id="share"></i><span class="ml-1">Share</span></div>
                                  </div>
                              </div>
                              <div id="collapse-1" class="bg-light p-2 collapse rounded-lg" data-parent="#myGroup">
                                  <form action="#"> 
                                      <input type="text" name="cmt" id="cmt" size="50">
                              ...
                              <div id="collapse-2" class="bg-light p-2 collapse" data-parent="#myGroup">
                                  <div class="d-flex flex-row align-items-start">
                                      <i class="fab fa-facebook-square border p-3 rounded mr-1 fa-2x"></i>
                                      <i class="fab fa-twitter border p-3 rounded mr-1 fa-2x"></i>
                                      <i class="fab fa-linkedin border p-3 rounded mr-1 fa-2x"></i>
                                      <i class="fab fa-instagram border p-3 rounded mr-1 fa-2x"></i>
                                      <i class="fab fa-dribbble border p-3 rounded mr-1 fa-2x"></i>
                                      <i class="fab fa-pinterest-p border p-3 rounded mr-1 fa-2x"></i>
                                  </div>
                              </div>
                          </div>
                    </div> 
                  </section>
                  <section class="card" data-aos="flip-left">
                    <div class="row">
                        <div class="col-4"></div>
...
<section class="container" style="background-color: #625d5d1c;">
    <div class="row">
        <div class="col-2"></div>
        <div  data-aos="fade-left" class="btn btn-warning rounded-circle col" >
            <h1 class="header " class="btn btn-white rounded-circle animate__animated animate__bounce" data-aos="animate text on scroll">
    ...
    <div class="row">
        ...
        <div class="card col-3 " data-aos="flip-up" style="width: 18rem;">
            <img src="https://4.bp.blogspot.com/-Epv2HqRcX_Q/VnfSEJIHFMI/AAAAAAAACz4/_HpB9pBi5Z4/s400/11202436_1996199580604309_3547350991846557808_n.jpg" class="card-img-top img-thumbnail" alt="...">
            <div class="card-body">
    ...
    <div class="row" data-aos="flip-up">
        <div class="col"></div>
        <div class="card col-3 " data-aos="flip-up" style="width: 18rem;">
            <img src="https://3.bp.blogspot.com/-_xcOMycXE4M/V5iPJmuluhI/AAAAAAAAFB0/QzG875pSY6wkz1b-eE6E16P4piSfrCbjACLcB/s400/13782097_729356553870777_4337323163510948274_n.jpg" class="card-img-top img-thumbnail" alt="...">
            <div class="card-body">
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
        </div> 
